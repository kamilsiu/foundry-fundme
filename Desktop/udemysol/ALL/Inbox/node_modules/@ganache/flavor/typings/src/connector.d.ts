...
export interface WebsocketConnector<Provider, RequestFormat, ResponseFormat> extends Connector<Provider, RequestFormat, ResponseFormat> {
    handle(payload: RequestFormat, connection: WebSocket<void>): Promise<{
