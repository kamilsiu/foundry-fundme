...
export type FlavorOptions<ProviderOptions extends OptionsConfig<any> | never, ServerOptions extends OptionsConfig<any> | never, CliOptions extends OptionsConfig<any> | never> = Clean<{
 ...
 * @internal
 */
export type AnyFlavor = Flavor<string, Connector<any, any, any>, {
    provider?: OptionsConfig<any>;
    server?: OptionsConfig<any>;
    cli?: OptionsConfig<any>;
}>;
export type Flavor<F extends string, C extends Connector<any, any, any>, O extends FlavorOptions<OptionsConfig<any>, OptionsConfig<any>, OptionsConfig<any>> = FlavorOptions<never, never, never>> = {
    flavor: F;
