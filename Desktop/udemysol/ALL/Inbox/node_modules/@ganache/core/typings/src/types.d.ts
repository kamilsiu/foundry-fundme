...
export type ProviderOptions<F extends AnyFlavor> = (F["flavor"] extends "ethereum" ? {
    flavor?: F["flavor"];
} : {
    flavor: F["flavor"];
...
export type InternalServerOptions = InternalOptions<NamespacedServerConfigOptions>;
export {};
